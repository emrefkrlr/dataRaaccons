    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_name', models.CharField(blank=True, max_length=120, null=True, verbose_name='Company Page Name')),
                ('url', models.CharField(blank=True, max_length=255, null=True, verbose_name='Company Main Url')),
                ('logo', models.CharField(blank=True, max_length=255, null=True, verbose_name='Company Logo')),
