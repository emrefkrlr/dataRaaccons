...
var KTChartsWidget22 = function() {
    var e = function(e, a, t, l) {
        ...
        if (o) {
            ...
            var r = { series: t, chart: { fontFamily: "inherit", type: "donut", width: 250 }, plotOptions: { pie: { donut: { size: "50%", labels: { value: { fontSize: "10px" } } } } }, colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-blue"), KTUtil.getCssVariableValue("--bs-pink"), KTUtil.getCssVariableValue("--bs-green"), KTUtil.getCssVariableValue("--bs-gray-dark"), KTUtil.getCssVariableValue("--bs-purple"), KTUtil.getCssVariableValue("--bs-orange"), KTUtil.getCssVariableValue("--bs-cyan"), KTUtil.getCssVariableValue("--bs-gray"), KTUtil.getCssVariableValue("--bs-yellow"), KTUtil.getCssVariableValue("--bs-teal"), KTUtil.getCssVariableValue("--bs-gray-700"), KTUtil.getCssVariableValue("--bs-secondary-rgb"), KTUtil.getCssVariableValue("--bs-indigo"), KTUtil.getCssVariableValue("--bs-gray-400"), KTUtil.getCssVariableValue("--bs-warning-rgb"), ], stroke: { width: 0 }, labels: KTChartsWidget22_chart_labels, legend: { show: !1 }, fill: { type: "false" } },
...
var KTChartsWidget22_for_main_company = function() {
    var e = function(e, a, t, l) {
        ...
        if (o) {
            parseInt(KTUtil.css(o, "height"));
            var r = { series: t, chart: { fontFamily: "inherit", type: "donut", width: 250 }, plotOptions: { pie: { donut: { size: "50%", labels: { value: { fontSize: "10px" } } } } }, colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-blue"), KTUtil.getCssVariableValue("--bs-pink"), KTUtil.getCssVariableValue("--bs-green"), KTUtil.getCssVariableValue("--bs-gray-dark"), KTUtil.getCssVariableValue("--bs-purple"), KTUtil.getCssVariableValue("--bs-orange"), KTUtil.getCssVariableValue("--bs-cyan"), KTUtil.getCssVariableValue("--bs-gray"), KTUtil.getCssVariableValue("--bs-yellow"), KTUtil.getCssVariableValue("--bs-teal"), KTUtil.getCssVariableValue("--bs-gray-700"), KTUtil.getCssVariableValue("--bs-secondary-rgb"), KTUtil.getCssVariableValue("--bs-indigo"), KTUtil.getCssVariableValue("--bs-gray-400"), KTUtil.getCssVariableValue("--bs-warning-rgb"), ], stroke: { width: 0 }, labels: KTChartsWidget22_chart_2_labels, legend: { show: !1 }, fill: { type: "false" } },
                i = new ApexCharts(o, r),
                s = !1,
                n = document.querySelector(e);
            !0 === l && (i.render(), s = !0), n.addEventListener("shown.bs.tab", (function(e) { 0 == s && (i.render(), s = !0) }))
