...
class GetirTasks(object):
    ...
    def getir_getir_crawler_tasks(self, activity_name):
        ...
        try:
            ...
            get_crawlers = CrawlerServices().fetch_urls_to_crawl({"status": 1, 'company__name': 'getir_getir', "activity__name": activity_name})
