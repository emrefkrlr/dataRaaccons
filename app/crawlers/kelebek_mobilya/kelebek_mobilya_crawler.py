...
class KelebekMobilyaCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("KelebekMobilyaCrawler get_innerHTML EXCEPTION: {}".format(e))
        ...
        try:
            ...
            for product in product_list:
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.kelebek.com' + articleURL['href'] if articleURL else None,
            ...
            print("KelebekMobilyaCrawler html_parser EXCEPTION: {}".format(e))