...
class IderMobilyaCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("IderMobilyaCrawler get_innerHTML EXCEPTION: {}".format(e))
        ...
        try:
            ...
            for product in product_list:
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.idermobilya.com' + articleURL[0]['href'] if articleURL else None,
                    'measurement_value': None,
                    'currenct_unit': 'tl',
                    'price': float(articlePrice if articlePrice != "" else None),
                    'image': "https://www.idermobilya.com" + articleImage["src"] if articleImage else None
                    }
            ...
            print("IderMobilyaCrawler html_parser EXCEPTION: {}".format(e))