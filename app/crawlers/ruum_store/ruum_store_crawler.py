...
class RuumStoreCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("RuumStoreCrawler get_innerHTML EXCEPTION: {}".format(e))
        ...
        try:
            ...
            for product in product_list:
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.ruumstore.com' + articleURL['href'] if articleURL else None,
            ...
            print("RuumStoreCrawler html_parser EXCEPTION: {}".format(e))