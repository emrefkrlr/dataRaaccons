...
class DogtasCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("DogtasCrawler get_innerHTML EXCEPTION: {}".format(e))
    ...
    def html_parser(self, html, crawler_config, page_category):
        ...
        try:
            ...
            for product in product_list:
                ...
                articleName = articleNameD.text.strip() + ' ' + articleName.text.strip()

                # Replace key character with value character in string
                if articlePrice:
                    articlePrice = functions.char_to_replace(articlePrice.text.strip())
                else:
                    articlePrice = 0
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.dogtas.com' + articleURL['href'] if articleURL else None,
            ...
            print("DogtasCrawler html_parser EXCEPTION: {}".format(e))