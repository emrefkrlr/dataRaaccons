...
class OcassoCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("OcassoCrawler get_innerHTML EXCEPTION: {}".format(e))
    ...
    def html_parser(self, html, crawler_config, page_category):
        ...
        try:
            ...
            for product in product_list:
                ...
                price = articlePrice.findChildren("h3", recursive=False)
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.ocasso.com.tr' + articleURL['href'] if articleURL else None,
            ...
            print("OcassoCrawler html_parser EXCEPTION: {}".format(e))