...
class MudoCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("MudoCrawler get_innerHTML EXCEPTION: {}".format(e))
    ...
    def html_parser(self, html, crawler_config, page_category):
        ...
        try:
            ...
            for product in product_list:
                ...
                articlePrice = functions.char_to_replace_separated_by_dots(articlePrice)

                product_detail = {
                    'product_id': str(uuid.uuid4().hex),
                    'category': page_category,
                    'product_name': articleName.text.strip() if articleName.text != "" else None,
                    'product_url': 'https://www.mudo.com.tr' + articleURL[0]['href'] if articleURL else None,
            ...
            print("MudoCrawler html_parser EXCEPTION: {}".format(e))