...
from crawlers.bellona import bellona_crawler
import datetime
import time
...
class BellonaTasks(object):
    ...
    def bellona_crawler_tasks(self, activity_name):
            ...
            for crawler in get_crawlers:
                ...
                if crawler.page_numbers >= 1:
                    ...
                    for page in range(1, crawler.page_numbers + 1):
                        ...
                        innerHTML = bellona_crawler.BellonaCrawler().get_innerHTML(crawler.page_url, css_selector, page)
                        
                        products_and_price = bellona_crawler.BellonaCrawler().html_parser(innerHTML, get_crawler_config, crawler.page_category)
