...
class KoctasCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("KoctasCrawler get_innerHTML EXCEPTION: {}".format(e))
        ...
        try:
            ...
            for product in product_list:
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.koctas.com.tr' + articleURL['href'] if articleURL else None,
                    'measurement_value': None,
                    'currenct_unit': 'tl',
                    'price': float(articlePrice if articlePrice != "" else None),
                    'image': articleImage['srcset'] if articleImage else None
                    }
            ...
            print("KoctasCrawler html_parser EXCEPTION: {}".format(e))