...
class VivenseCrawler(object):
    ...
    def get_innerHTML(self, url, css_selector, page=None):
        ...
        try:
            ...
            print("VivenseCrawler get_innerHTML EXCEPTION: {}".format(e))
        ...
        try:
            ...
            for product in product_list:
                ...
                product_detail = {
                    ...
                    'product_url': 'https://www.vivense.com' + articleURL['href'] if articleURL else None,
            ...
            print("html_parser html_parser EXCEPTION: {}".format(e))